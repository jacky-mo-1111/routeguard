...
def get_logits_processor(extra_processors: "Optional[list[LogitsProcessor]]" = None) -> "LogitsProcessorList":
    r"""Get logits processor that removes NaN and Inf logits, plus optional extras."""
    logits_processor = LogitsProcessorList()
    logits_processor.append(InfNanRemoveLogitsProcessor())
    if extra_processors:
        for proc in extra_processors:
            if proc is not None:
                logits_processor.append(proc)
